...
$(document).ready(function() {
  ...
  if(cssPrefix) {
    // 300 x 233
    var cols = 14; // Desired columns
    var rows = 10; // Desired rows
    var totalWidth = 418; // Logo width
    var totalHeight = 306; // Logo height
    ...
    var logo = jQuery("#logo").css("backgroundImage","none").html("");
